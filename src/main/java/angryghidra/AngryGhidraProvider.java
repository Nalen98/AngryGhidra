    ...
    private void buildPanel() {
        ...
        gl_SAPanel.setHorizontalGroup(
        	gl_SAPanel.createParallelGroup(Alignment.TRAILING)
        		.addGroup(gl_SAPanel.createSequentialGroup()
        			...
        			.addGap(31)
        			.addComponent(ArgPanel, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
        			.addContainerGap())
        );
        ...
        gl_CSOPanel.setHorizontalGroup(
        	gl_CSOPanel.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(gl_CSOPanel.createSequentialGroup()
        			.addGap(6)
        			.addComponent(MemPanel, GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
        			.addGap(28))
        		.addGroup(gl_CSOPanel.createSequentialGroup()
        			.addGap(12)
        			.addComponent(RegPanel, GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE)
        			.addGap(28))
        		.addGroup(gl_CSOPanel.createSequentialGroup()
        			.addContainerGap()
        ...
        gl_CSOPanel.setVerticalGroup(
        	gl_CSOPanel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_CSOPanel.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(MemPanel, GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
        			.addGap(89)
        			.addComponent(lbRegisters)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(RegPanel, GroupLayout.DEFAULT_SIZE, 49, Short.MAX_VALUE)
        			.addGap(114))
        );
        	...
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(gl_panel.createSequentialGroup()
        					.addContainerGap()
        					.addComponent(EndPanel, GroupLayout.DEFAULT_SIZE, 599, Short.MAX_VALUE)))
        			.addGap(13))
        );
        gl_panel.setVerticalGroup(
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(EndPanel, GroupLayout.PREFERRED_SIZE, 134, GroupLayout.PREFERRED_SIZE))
        );
            ...
            public void actionPerformed(ActionEvent e) {
                {
                    ...
                    if (TFReg1.getText().isEmpty() == false & TFVal1.getText().isEmpty() == false) {
                        ...
                        for (int i = 0; i < TFregs.size(); i++) { 
                        	if (TFregs.get(i).getText().isEmpty() == false & TFVals.get(i).getText().isEmpty() == false) {
