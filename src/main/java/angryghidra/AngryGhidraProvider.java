    ...
    private void buildPanel() {
        ...
        gl_CSOPanel.setHorizontalGroup(
            ...
            .addGroup(gl_CSOPanel.createSequentialGroup()
                .addComponent(lbMemory, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
                .addContainerGap(122, Short.MAX_VALUE))
            .addGroup(gl_CSOPanel.createSequentialGroup()
                .addContainerGap()
                .addComponent(MemPanel, GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
                .addGap(24))
            .addGroup(gl_CSOPanel.createSequentialGroup()
                .addContainerGap()
                .addGroup(gl_CSOPanel.createParallelGroup(Alignment.LEADING)
                    ...
                    .addComponent(WMPanel, GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE))
                .addGap(25))
            .addGroup(gl_CSOPanel.createSequentialGroup()
                .addContainerGap()
                .addComponent(RegPanel, GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                .addGap(30))
            .addGroup(gl_CSOPanel.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbRegisters, GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
                .addContainerGap())
        );
        gl_CSOPanel.setVerticalGroup(
            ...
            .addGroup(gl_CSOPanel.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(MemPanel, GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
                .addGap(23)
                .addComponent(lblWriteToMemory)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(WMPanel, GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                .addGap(18)
                .addComponent(lbRegisters)
                .addGap(9)
                .addComponent(RegPanel, GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
                .addGap(54))
        );
        ...
        JLabel lbHook = new JLabel("Registers hooks");
        lbHook.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        gl_HookPanel.setHorizontalGroup(
            ...
            .addGroup(gl_HookPanel.createSequentialGroup()
                .addContainerGap()
                .addGroup(gl_HookPanel.createParallelGroup(Alignment.LEADING)
                    .addComponent(lbHook, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE)
                    .addGroup(gl_HookPanel.createSequentialGroup()
                        .addComponent(btnAddHook, GroupLayout.PREFERRED_SIZE, 85, Short.MAX_VALUE)
                        .addGap(13)))
                .addGap(30)
                .addComponent(RegHookPanel, GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                .addContainerGap())
        );
        gl_HookPanel.setVerticalGroup(
            ...
            .addGroup(gl_HookPanel.createSequentialGroup()
                .addGroup(gl_HookPanel.createParallelGroup(Alignment.TRAILING)
                    .addGroup(gl_HookPanel.createSequentialGroup()
                        .addGap(10)
                        .addComponent(RegHookPanel, GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                        .addGap(10))
